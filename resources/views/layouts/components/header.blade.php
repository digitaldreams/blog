...
<nav class="navbar navbar-expand-md navbar-dark bg-secondary">
    ...
    <ul class="navbar-nav m-auto d-none d-md-inline-flex">
        <li class="nav-item">
            <a class="nav-link" href="{{route('blog::tags.index')}}">Tags <span class="sr-only">Tags</span></a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="{{route('blog::posts.index')}}">Posts</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="{{route('blog::categories.index')}}">Categories</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="{{route('blog::newsletters.index')}}">Newsletter</a>
        </li>
    </ul>
    <div class="dropdown">
...
<nav class="nav nav-pills nav-fill  fixed-bottom  navbar-light bg-light text-center d-md-none">
    <a class="nav-item nav-link " href="{{route('blog::tags.index')}}">Tags </a>
    <a class="nav-item nav-link" href="{{route('blog::categories.index')}}">Categories</a>
    <a class="nav-item nav-link" href="{{route('blog::posts.index')}}">Posts</a>
    <a class="nav-item nav-link " href="{{route('blog::posts.home')}}">Blog Front</a>
</nav>
